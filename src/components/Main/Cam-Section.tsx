...
function Historico() {
    ...
    return (
        <div className="min-h-[35vh] md:min-h-[60vh] p-5 rounded-lg mb-5">
            ...
            <main className="flex">
                ...
                <div className="w-[100%] md:w-[40%] mx-2 flex flex-col items-center gap-2 p overflow-scrol  overflow-x-hidden max-h-[30vh] md:max-h-[55vh]">
                    {
